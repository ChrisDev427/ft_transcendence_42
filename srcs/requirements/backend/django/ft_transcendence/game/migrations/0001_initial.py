<<<<<<< HEAD
# Generated by Django 4.2 on 2024-01-12 08:19
=======
# Generated by Django 3.2.4 on 2024-02-02 10:00
>>>>>>> origin/axel
...
<<<<<<< HEAD
                ('final_score', models.CharField(max_length=25)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('player_one', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='player_one', to=settings.AUTH_USER_MODEL)),
                ('player_two', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='player_two', to=settings.AUTH_USER_MODEL)),
